% ============================================================
% ЛАБОРАТОРНА РОБОТА 4 (9) — Варіант 7
% Моделювання об'єктів управління на основі нейронних мереж
% ============================================================
% Функція 1 (двовимірна): z1(x,y) = sin(x) * sin(y)
%   Входи x, y в [0, pi/2]
% Функція 2 (одновимірна): y(x) = sin(x^2) / x
%   Вхід x в [0.1, pi]   (починаємо з 0.1, щоб уникнути ділення на 0)
% ============================================================
...
%% ============================================================
%  ЧАСТИНА 2: y(x) = sin(x^2) / x
%% ============================================================
fprintf('\n==========================================================\n');
fprintf('   ЧАСТИНА 2:  y(x) = sin(x^2) / x\n');
fprintf('==========================================================\n');

% x починається з 0.1 щоб уникнути ділення на нуль при x=0
x2_vec  = linspace(0.1, pi, N);
Input2  = x2_vec;
Output2 = sin(x2_vec.^2) ./ x2_vec;
